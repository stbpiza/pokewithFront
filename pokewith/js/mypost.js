...
for(let i = 0; i<resultData.length; i++){
  if(num == resultData[i].p_id){
    ...
    let commentText = '';
    commentText += '<div> <p class="commentP"> <input type="checkbox" id="checkUser'+resultData[i].c_id+'" class="checkUser" onclick="checkUser(this)" name="'+resultData[i].c_id+'" value="'+ resultData[i].checkNum +'">' + resultData[i].nickname1 + "</div>";
      ...
      for(let j = 0; j< resultData[i].checkNum.length; j++){
        ...
        switch(onePersonCheckNum){
          case '1' :
            ...
            showNickMaker(resultData[i].nickname1, resultData[i].friendCode1, resultData[i].c_id);
            break;
          case '2' : 
            showNickMaker(resultData[i].nickname2, resultData[i].friendCode2, resultData[i].c_id);
            break;
          case '3' : 
            showNickMaker(resultData[i].nickname3, resultData[i].friendCode3, resultData[i].c_id);
            break;
          case '4' : 
            showNickMaker(resultData[i].nickname4, resultData[i].friendCode4, resultData[i].c_id); 
            break;
          case '5' : 
            showNickMaker(resultData[i].nickname5, resultData[i].friendCode5, resultData[i].c_id);
            break;
        }
      }
    }
...
function showNickMaker(nickname, friendCode, c_id){
